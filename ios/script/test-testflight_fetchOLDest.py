...
class PWBFunc:
    ...
    def installoldest(self,d):
        ...
        if d.xpath('//*[@label="PlumeDevelopment"]').exists:
            ...
            # OLDest
            if d.xpath('//CollectionView/Cell[5]').exists:
                logdef.info("Press OLDEST item")
                d.xpath('//CollectionView/Cell[5]').click()
           ...
           if d(label="Your email").exists:
              ...
              if d(label="Done").exists:
                 ...
                 if d(name="EmailEntryAuthenticationViewController.nextButton").exists:
                    ...
                    if d.xpath('//Window[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[2]/Other[3]').exists:
                       d.xpath('//Window[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[1]/Other[2]/Other[3]').click()
                       time.sleep(1)   
...
class TestAPI(TestAPIWrap):
    ...
    def test_beacon_func(self):
        ...
        ## Install IPK OLDEST build
        PWBFunc().installoldest(d)
