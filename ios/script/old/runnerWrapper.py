...
def authtokenpost(url, Token=None, Id=None):
    ...
    """
    curl -X 'POST' \
      'https://staging-rest.pwb.plume-dev.com/pwb/AuthenticateWithPlumeToken' \
...
def CloudLoginpost(url, json=None):
    ...
    """
    curl -X 'POST' \
      'https://staging-rest.pwb.plume-dev.com/pwb/PlumeCloudLogin' \
      -H 'accept: application/json' \
      -H 'Content-Type: application/json' \
      -d '{
...
def ToRegdevicepost(url, FinalaccessToken,clouduserid,subscriptionIdnumber):
    #Step 3
    """
    For RegisterDevice
    ##################
    curl -X 'POST' \
      'https://staging-rest.pwb.plume-dev.com/pwb/RegisterDevice' \
      -H 'accept: application/json' \
    ...
    json = {"userId": str(clouduserid), "deviceId": str(DEVID) , "subscriptionId": str(subscriptionIdnumber)}
