...
class PWBFunc:
    ...
    @allure.feature("Step 2 :  /pwb/AuthenticateWithPlumeToken")
    ...
    @allure.feature("Step 1 :  /pwb/PlumeCloudLogin")
...
class TestAPI(TestAPIWrap):
    ...
    def test_thrive_connect(self):
        """
        To verify cloud url to https://thrive-ci-usw2-api.data.plume.tech/ 
        """
        logdef.info("#########################################################################\n")
        logdef.info("# API Cloud URL (URL:thrive-ci-usw2-api.data.plume.tech/                #\n")
        logdef.info("#########################################################################\n")
        with allure.step("Entry to thrive-ci-usw2-api.data.plume.tech"): 
            ...
            logdef.info("--- JSON Download via Plume Ci Cloud as below:\n")
            logdef.info(text)
