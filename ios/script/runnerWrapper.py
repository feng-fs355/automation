...
def authtokenpost(url, Token=None, Id=None):
    ...
    """
    curl -X 'POST' \
      'https://thrive-ci-usw2-api.data.plume.tech/pwb/AuthenticateWithPlumeToken' \
...
def CloudLoginpost(url, json=None):
    ...
    """
    curl -X 'POST' \
      'https://thrive-ci-usw2-api.data.plume.tech/pwb/PlumeCloudLogin' \
      -H 'accept: application/json' \
      -H 'Content-Type: application/json' \
      -d '{
      "email": "zhicheng+2@plume.com",
      "password": "plume1234",
      "ttl": 3600
    }'
    """
...
def ToUNRegdevicepost(url, FinalaccessToken,Cdevid,SN): # modify 20230310
    ...
    ##################
    curl -X 'POST' \
      'https://thrive-dog1-usw2-api.data.plume.tech/pwb/UnregisterDevice' \
      -H 'accept: application/json' \
      -H 'Authorization: Bearer eyJraWQiOiJ1cy13ZXN0LTIxIiwidHlwIjoiSldTIiwiYWxnIjoiUlM1MTIifQ..jqQkrglzBDavRR5bB_A2t1ak1Jzoot4pLzutKIlQ6dq8lm9A0vqcKebtF368IYS_3LHxOrtCpR8r4OAx84uCjMw414HGdCeMs5ZOoYV-4Pp678k_75p3i8l49eveHC6JixUQ06PazAQzUf-HR0Zo_fN3nZ2vYeA-ng88jwypRO1L0T1PKHwimosfIjkkHM3mzUQ-8BrLQCYayE2Ftni4bnMG56S0Je_IHrDD9oy1hfftda-ryuBcQaxUn5BQ9GdRGGNMWol27Fwf5D9OjGe3xVOGtasuM3azOHob2g-_2vuVHYgqLIw_HUraue56eNV2x5Om14c7geX7-jiTOxlpcA' \
      -H 'Content-Type: application/json' \
      -d '{
...
def ToGetReadinessInsightSummary(url, FinalaccessToken,STime,ETime): # modify 20230531
    ...
    ##################
    curl -X 'POST' \
      'https://thrive-dog1-usw2-api.data.plume.tech/pwb/UGetReadinessInsightSummary' \
      -H 'accept: application/json' \
      -H 'Authorization: Bearer eyJraWQiOiJ1cy13ZXN0LTIxIiwidHlwIjoiSldTIiwiYWxnIjoiUlM1MTIifQ..jqQkrglzBDavRR5bB_A2t1ak1Jzoot4pLzutKIlQ6dq8lm9A0vqcKebtF368IYS_3LHxOrtCpR8r4OAx84uCjMw414HGdCeMs5ZOoYV-4Pp678k_75p3i8l49eveHC6JixUQ06PazAQzUf-HR0Zo_fN3nZ2vYeA-ng88jwypRO1L0T1PKHwimosfIjkkHM3mzUQ-8BrLQCYayE2Ftni4bnMG56S0Je_IHrDD9oy1hfftda-ryuBcQaxUn5BQ9GdRGGNMWol27Fwf5D9OjGe3xVOGtasuM3azOHob2g-_2vuVHYgqLIw_HUraue56eNV2x5Om14c7geX7-jiTOxlpcA' \
      -H 'Content-Type: application/json' \
      -d '{
    ...
    # 20231018 add by Zeno
def ToGetDailyReadinessInsightList(url, FinalaccessToken,STime,ETime): 
    logdef.info(url)
    """
    For GetDailyReadinessInsightList
    ##################

    curl -X 'POST' \
      'https://thrive-dog1-usw2-api.data.plume.tech/pwb/GetDailyReadinessInsightList' \
      -H 'accept: application/json' \
      -H 'Authorization: Bearer eyJraWQiOiJ1cy13ZXN0LTIzIiwidHlwIjoiSldTIiwiYWxnIjoiUlM1MTIifQ..bGUWZ0H9bLcEWYUYsDalOCh9R4yQij5jhxIuCrQRmBdXYRdh_oF4YvOiscWM6tOOgM1hH5tYgtEiLbScT7tFMgM5bMbVmcd8Dn5FK_ieWK--43jd5UzTvb2A-lgpfdiUQ4-9blLoCLP1sgVWKt33XXvxf-RCcD-ijhoDIaZVXaVMJLxGSn4q2bN95Ti3WOxCdN6e6gu6LGJzZexbuokSZuWDwm5YMnViJBEMqB2qejh33YlstAWSmpihcmY0MiEEUESomjS5s1yTJCyizU8ujGfxCgcGqpqAL4mI7g16S1KCvSUyM1ILT_Z5NsgZ3yrn4T0Aze_OlI9z2jr1VKGrmg' \
      -H 'Content-Type: application/json' \
      -d '{
           "userId": "6489599c9a2357000b2dc384",
           "startTime": 1697558400,
           "endTime": 1697641200,
           "pageSize": 7,
           "startKey": ""
     }'
    ...
    json = {"userId": str(USERID), "startTime": STime ,"endTime": ETime, "pageSize": 7, "startKey": "" }
    #response = requests.get(bl_url, headers=headers)
...
def ToGetFitnessInsightSummary(url, FinalaccessToken,STime,ETime): # modify 20230526
    ...
    #20231109 add by Zeno
def ToGetFitnessActivityList(url, FinalaccessToken,STime,ETime): 
    logdef.info(url)
    """
    For GetFitnessActivityList
    ##################
    curl -X 'POST' \
      'https://thrive-dog1-usw2-api.data.plume.tech/pwb/GetFitnessActivityList' \
      -H 'accept: application/json' \
      -H 'Authorization: Bearer eyJraWQiOiJ1cy13ZXN0LTIxIiwidHlwIjoiSldTIiwiYWxnIjoiUlM1MTIifQ..jqQkrglzBDavRR5bB_A2t1ak1Jzoot4pLzutKIlQ6dq8lm9A0vqcKebtF368IYS_3LHxOrtCpR8r4OAx84uCjMw414HGdCeMs5ZOoYV-4Pp678k_75p3i8l49eveHC6JixUQ06PazAQzUf-HR0Zo_fN3nZ2vYeA-ng88jwypRO1L0T1PKHwimosfIjkkHM3mzUQ-8BrLQCYayE2Ftni4bnMG56S0Je_IHrDD9oy1hfftda-ryuBcQaxUn5BQ9GdRGGNMWol27Fwf5D9OjGe3xVOGtasuM3azOHob2g-_2vuVHYgqLIw_HUraue56eNV2x5Om14c7geX7-jiTOxlpcA' \
      -H 'Content-Type: application/json' \
      -d '{
           "userId": "6489599c9a2357000b2dc384",
           "startTime": 1699459200,
           "endTime": 1699542000,
           "pageSize": 5,
           "startKey": ""
     }'
    ...
    json = {"userId": str(USERID), "startTime": STime ,"endTime": ETime ,"pageSize": 5,  "startKey": "" }
    #response = requests.get(bl_url, headers=headers)
...
# Add by Feng 20231213
# request to /pwb/GetFallEventSummary
def ToGetFallEventSummary(url, FinalaccessToken,STime,ETime):
    #url = "https://thrive-dog1-usw2-api.data.plume.tech/pwb/GetFallEventSummary"
    """
    json = {
        "userId": str(userId),
        "startTime": startTime,
...
def TOLogfilgetfromCI(url, FinalaccessToken, Cpages): # add 20230313
    ...
    ##################
    curl -X 'POST' \
      'https://thrive-ci-usw2-api.data.plume.tech/pwb/GetLogFile' \
      -H 'accept: application/json' \
      -H 'Authorization: Bearer eyJraWQiOiJ1cy13ZXN0LTIxIiwidHlwIjoiSldTIiwiYWxnIjoiUlM1MTIifQ..jqQkrglzBDavRR5bB_A2t1ak1Jzoot4pLzutKIlQ6dq8lm9A0vqcKebtF368IYS_3LHxOrtCpR8r4OAx84uCjMw414HGdCeMs5ZOoYV-4Pp678k_75p3i8l49eveHC6JixUQ06PazAQzUf-HR0Zo_fN3nZ2vYeA-ng88jwypRO1L0T1PKHwimosfIjkkHM3mzUQ-8BrLQCYayE2Ftni4bnMG56S0Je_IHrDD9oy1hfftda-ryuBcQaxUn5BQ9GdRGGNMWol27Fwf5D9OjGe3xVOGtasuM3azOHob2g-_2vuVHYgqLIw_HUraue56eNV2x5Om14c7geX7-jiTOxlpcA' \
      -H 'Content-Type: application/json' \
      -d '{
