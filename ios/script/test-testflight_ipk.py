...
class PWBFunc:
    ...
    def installbutton(self,d):
        if d.xpath('//Cell/Other[2]/Other[1]/Other[1]/Other[1]/Button[1]').exists:
            logdef.info("Install Button is displayed")
            d.xpath('//Cell/Other[2]/Other[1]/Other[1]/Other[1]/Button[1]').click() 
            time.sleep(15)
            logdef.info("Install HomePass is Processing")
            d.screenshot().save("./pic/Installing.png") 
            allure.attach.file("./pic/Installing.png" , attachment_type=allure.attachment_type.PNG) 
            ########################################
            # Default time is 60 sec
            #time.sleep(60)
            # For low network bandwidth condition
            time.sleep(120)
            ########################################
