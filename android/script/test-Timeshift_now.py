...
class PWBFunc:
    ...
    def LoadJSONFile(self):
        ...
        output_arr[len(output_arr)-1]["timestamp"]
        logdef.info(output_arr[len(output_arr)-1]["timestamp"])
        logdef.info("json end time")
        ...
        time_shift= time_stamp - output_arr[len(output_arr)-1]["timestamp"]
